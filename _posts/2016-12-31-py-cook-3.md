...
[NumPy 라이브러리]는 이런 문제에 사용될 수 있는  `matrix` 객체를 가집니다. 행렬은 [3.9장](#calculating-with-large-numerical-arrays) 에서 설명한 배열 객체와 유사하지만, 계산하기 위해서는 선형 대수 규칙을 따라야 합니다. 여기 매우 필요한 기능을 설명한 예제가 있습니다.
