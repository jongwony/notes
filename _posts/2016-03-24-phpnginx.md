...
<div class="def">
baseurl=http://nginx.org/packages/rhel/$releasever/$basearch/ 을 권장하지만 <br>
인식을 하지 않는 경우가 있어 정확한 주소를 기입하였습니다. <br>
...
아키텍쳐에 맞는 주소를 찾은 것입니다.

[http://download.fedoraproject.org/pub/epel/](http://download.fedoraproject.org/pub/epel/) 링크 하위 항목에서 찾으시면 됩니다.
