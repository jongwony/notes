...
그 예로 [8.11장]()이 있습니다. 시그니처 객체를 사용하면 이것이 간단해집니다.
...
이는 일반적으로 *dictionary*지만 실제로 [9.14장]()에 설명된 것처럼 `__prepare__()` 메서드에 의해 반환되는 객체입니다.
...
frame hacking에 대한 다른 예제는 [2.15장]()에 있습니다.
