...
rem
rem	The table has a high pctfree to reduce the volume redo generated
rem	whilst still makeing the table quite large.
rem
...
rem
rem	Concurrency tests like this tend to behave differently on single
rem	CPU machines, as there are some special code paths in Oracle that
rem	are used when Oracle 'knows' that there is no point in waiting for
rem	another session to release a resource.
rem
