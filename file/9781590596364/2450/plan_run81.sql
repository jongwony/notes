...
rem
rem	When you call plan_run8, it will (try to) explain the plan into the default
rem	table PLAN_TABLE, and then produce three reports from that table. 
rem
rem	The plan_run8.sql script can be kept in a centralised location, as it invokes
...
rem	that holds the plan_run8.sql script. 
rem
