...
rem	The base data has to be generated by bitmap_cost_01.sql
rem
rem	An example of how setting columns to NOT NULL makes a difference
rem
...
prompt	The next line should be redundant
prompt	and will produce an error message
