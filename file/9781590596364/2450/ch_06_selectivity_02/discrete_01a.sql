...
rem	Repeates discrete_01.sql but add a histogram -
rem	which solves the problem
rem
...
select 
	14000 * (2/98 + 2/13)	std_between_card_99,
	14000 * (2/12 + 2/13)	std_between_card_13
from dual;
