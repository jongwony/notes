...
관련된 하나의 트릭(꽤 산뜻한)은 `generator expression`을 사용하여 데이터를 문자열과 `concatenation`으로 동시에 변환하는 것입니다. [1.19장](/2016/12/19/py-cook-1.html#119-transforming-and-reducing-data-at-the-same-time)을 참조하시길 바랍니다.
